...
# vgg16             fingernail-anemia   base            base      base
# vit-tiny          fingernail-anemia   base            base      base
# convnext-tiny     fingernail-anemia   base            base      base
# efficientnet-b0   fingernail-anemia   base            base      base
...
# tinynet-a         fingernail-anemia   base            base      base

# mobilenetv2       fingernail-anemia   qat            base      base
# resnet18          fingernail-anemia   qat            base      base
# vgg16             fingernail-anemia   qat            base      base
# vit-tiny          fingernail-anemia   qat            base      base
# convnext-tiny     fingernail-anemia   qat            base      base
# efficientnet-b0   fingernail-anemia   qat            base      base
...
# tinynet-a         fingernail-anemia   qat            base      base

mobilenetv2       fingernail-anemia   base            structured      base
resnet18          fingernail-anemia   base            structured      base
vgg16             fingernail-anemia   base            structured      base
vit-tiny          fingernail-anemia   base            structured      base
convnext-tiny     fingernail-anemia   base            structured      base
efficientnet-b0   fingernail-anemia   base            structured      base
...
tinynet-a         fingernail-anemia   base            structured      base

mobilenetv2       fingernail-anemia   base            unstructured      base
resnet18          fingernail-anemia   base            unstructured      base
vgg16             fingernail-anemia   base            unstructured      base
vit-tiny          fingernail-anemia   base            unstructured      base
convnext-tiny     fingernail-anemia   base            unstructured      base
efficientnet-b0   fingernail-anemia   base            unstructured      base
...
tinynet-a         fingernail-anemia   base            unstructured      base